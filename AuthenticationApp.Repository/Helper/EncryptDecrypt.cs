...
namespace AuthenticationApp.Repository.Helper
{
    ...
    public class EncryptDecrypt
    {
        ...
        public static string Encrypt(string Data)
        {
            ...
            string strEncrypt = Convert.ToBase64String(bytEncrypt);
            return strEncrypt;
        }
        ...
        /// <param name="strEncryption">The string encryption.</param>
        /// <returns></returns>
        ...
        /// </summary>
        /// <param name="input">The input.</param>
        /// <param name="strDecryption">The string decryption.</param>
        /// <returns></returns>
